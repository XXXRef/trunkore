...
//====================================================================================================
CModulesManager::~CModulesManager() inline {}
...
void CModulesManager::loadModule(const TYPE_JOBMODID &modID) {
	...
	if (libIter == this->modules.end()) {
		auto insertIter=this->modules.insert({ modID,{ std::make_shared<config::TYPE_MODULEMANAGER>(),1 } }); //insert can get rvalue refs: created pair moved
...
//====================================================================================================
CModulesManager::ExModulesManager::ExModulesManager(const std::string &par_exInfo) inline: exInfo(par_exInfo) {}

//====================================================================================================
std::string CModulesManager::ExModulesManager::getInfo() const inline {
